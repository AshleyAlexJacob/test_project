...
class PopularCarCard extends StatelessWidget {
  ...
  PopularCarCard({this.myCar, this.onPress});
  @override
          ...
          children: [
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: Center(
                            child: Text(
                              myCar.rating.toDouble().toString(),
            ...
            Padding(
              padding: EdgeInsets.only(
                  right: 10.0, left: 20.0, top: 5.0, bottom: 10.0),
              child: Text(
                myCar.name ?? 'Error',
                overflow: TextOverflow.ellipsis,
                style: TextStyle(
                    fontFamily: 'OP_S', color: Colors.black, fontSize: 20),
              ),
            ),
            Padding(
